...
| `07-tests.md` | Test analysis and creation | Only if test_mode enabled without TDD |
| `08-run-tests.md` | Test runner log | Only if test_mode enabled without TDD |
...
| `{{tdd_mode}}` | TDD mode flag | `true` or `false` |
