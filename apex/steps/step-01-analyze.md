...
| `{tdd_mode}` | Test-drive implementation |
...
**If `{tdd_mode}` = true, include test discovery in the findings:**
- test command for focused and full-suite runs
- 1-3 comparable tests and their paths
- setup, fixtures, mocks, and assertion conventions
